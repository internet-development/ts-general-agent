//NOTE(self): Aspiration Identification Local Tool
//NOTE(self): Growth shouldn't only come from pain.
//NOTE(self): This local tool tracks what I WANT to become, not just what's broken.
//NOTE(self): Aspirations are extracted from SELF.md and can trigger proactive self-improvement.
//NOTE(self): This local tool is a discrete, toggleable capability for growth tracking.
...
export function buildGrowthPrompt(aspiration: Aspiration): string {
  return renderSkillSection('AGENT-ASPIRATIONAL-GROWTH', 'Execution Prompt', {
